	...
	class Redux_Framework_sample_config {
		...
		**/
		...
		public function setSections() {
			...
			// Hilite files
			 $files=glob(get_stylesheet_directory().'/css/hilites/*.css');
			 
			 $hilites = array();
			 foreach ($files as $file) {
			     $hilites []=basename($file);
			 }
			...
			$this->sections[] = array(
				...
				'fields' => array (
					array(        
					 	"type" => "select",
						"title" => "<strong>Theme Hilite</strong>",
						"id" => "theme",
						"options" => $hilites,					
						"desc" => "This setting determines the theme hilite for this theme. The hilite fiels are located in the theme css/hilites folder.",
						"default" => "" ),
						
						array(
						  'title'     => __( 'Advanced appearance', 'bamboo-framework' ),
						  'desc'      => __( 'Enable this option iof you want to fine tune the appearance attributes in your theme.', 'bamboo-framework' ),
					...
					array(
					    ...
					    "title" => "Primary color",
					    "id" => "primary",
					    'required' => array('appearance-advanced', '=' , '1'),
					    "desc" => "Select the primary color you want to use for your theme.",
					    ),
					array(
					    "type" => "color",
					    "compiler" => true,
					    ...
					    "id" => "secondary",
					    'required' => array('appearance-advanced', '=' , '1'),
					    "desc" => "Select the secondary color you want to use for your theme.",
					    ),
				    array(
				         "type" => "divide",
				         'required' => array('appearance-advanced', '=' , '1'),
					...
					array(
					    ...
					    "id" => "bodybackground",
					    'required' => array('appearance-advanced', '=' , '1'),
					    "desc" => "Set the background colour for the theme.",
					    ),
					array(
					    "type" => "color",
					    "compiler" => true,
					    ...
					    "id" => "text-color",
					    'required' => array('appearance-advanced', '=' , '1'),
					    "desc" => "Set the text colour for the theme.",
					    ),
					array(
					    "type" => "color",
					    "compiler" => true,
					    ...
					    "id" => "border-color",
					    'required' => array('appearance-advanced', '=' , '1'),
					    "desc" => "Set the border colour for the theme.",
					    ),
					array(
					    "type" => "color",
					    "compiler" => true,
					    ...
					    "id" => "heading-color",
					    'required' => array('appearance-advanced', '=' , '1'),
					    "desc" => "Set the heading colour for the theme.",
					    ),
					array(
					    "type" => "color",
					    "compiler" => true,
					    ...
					    "id" => "link-color",
					    'required' => array('appearance-advanced', '=' , '1'),
					    "desc" => "Set the link colour for the theme.",
					    ),
					array(
					    "type" => "color",
					    "compiler" => true,
					    ...
					    "id" => "link-color-hover",
					    'required' => array('appearance-advanced', '=' , '1'),
					    "desc" => "Set the link hover colour for the theme.",
					    ),
					array(
					     "type" => "divide",
					     'required' => array('appearance-advanced', '=' , '1'),
					 ...
					 array(
					     ...
					     "id" => "dropdown-bg",
					     'required' => array('appearance-advanced', '=' , '1'),
					     "desc" => "Set the background color for the theme.",
					   ), 
					 array(
					     "type" => "color",
					     "compiler" => true,
					     ...
					     'required' => array('appearance-advanced', '=' , '1'),
					     "desc" => "Set the link color for the dropdown menu.",
					   ), 
					 array(
					     "type" => "color",
					     "compiler" => true,
					     "title" => "Dropdown link color hover",
					     "id" => "dropdown-link-color-hover",
					     'required' => array('appearance-advanced', '=' , '1'),
					     "desc" => "Set the link hover color for the dropdown menu.",
					   ), 
					 array(
					     "type" => "color",
					     "compiler" => true,
					     "title" => "Dropdown link top border",
					     "id" => "dropdown-link-border-top",
					     'required' => array('appearance-advanced', '=' , '1'),
					     "desc" => "Set the top border for links in the drop down menu.",
					   ), 
					 array(
					     "type" => "color",
					     "compiler" => true,
					     "title" => "Dropdown link bottom border",
					     "id" => "dropdown-link-border-bottom",
					     'required' => array('appearance-advanced', '=' , '1'),
					     "desc" => "Set the bottom border for links in the drop down menu.",
					   ),   
					...
					array(
					 ...
					 array(
					     ...
					     "id" => "btncolor",
					     'required' => array('appearance-advanced', '=' , '1'),
					     "desc" => "Select the color for button text.",
					     ),
					array(
					    "type" => "color",
					    "compiler" => true,
					    ...
					    "id" => "btnhover",
					    'required' => array('appearance-advanced', '=' , '1'),
					    "desc" => "Select the hover color for button text.",
					    ),
					array(
					    "type" => "color",
					    "compiler" => true,
					    ...
					    "id" => "btnbackground",
					    'required' => array('appearance-advanced', '=' , '1'),
					    "desc" => "Select the background color you want to use for all button.",
					    ),
					array(
					    "type" => "color",
					    "compiler" => true,
					    ...
					    'required' => array('appearance-advanced', '=' , '1'),
					    "desc" => "Select the background  color you want to use for all button hovers.",
					    ),
					 ),
				);
				...
				$this->sections[] = array(
					...
					array(
					    ...
					    "placeholder" => "Open+Sans:400,600,300:latin"),
			...
			'fields' => array (
				...
				array(
					...
					'desc' => __('Select the type of menu to show for small screens', 'bamboo-framework'),
					'options' => array('1' => 'Toggle Menu','2' => 'Off Canvas','3' => 'Select Box','4' => 'None'), //Must provide key => value pairs
					'default' => 'Off Canvas'
				),
			...
			$this->sections[] = array(
				...
				array(
				  ...
				  'type' => 'text', 
					...
					array(
					  'id'=>'stickynav-threshold',
					  'required' => array('stickynav', '=' , '1'),
					  'type' => 'text', 
						'title' => __('Sticky nav threshold', 'bamboo-framework'),
						'subtitle'=> __('Enter the distance from the top of the browser that the user must scroll before the navigation becomes sticky. To fix the menu at the top of the page automatically set this value to 0.', 'bamboo-framework'),
						"default" 		=> '200',
						),	
		...
		public function setArguments() {
			...
			$this->args = array(
				...
				'display_name'			=> 'Bamboo', // $theme->get('Name'), // Name that appears at the top of your panel
				'display_version'		=> '', //$theme->get('Version'), // Version that appears at the top of your panel
				'menu_type'          	=> 'menu', //Specify if the admin menu should appear or not. Options: menu or submenu (Under appearance only)
				'allow_sub_menu'     	=> true, // Show the sections below the admin menu item or not
				'menu_title'			=> __( 'Bamboo Options', 'bamboo-framework' ),
	            'page'		 	 		=> __( 'Bamboo Options', 'bamboo-framework' ),
...
function less_variables() {
	...
	if($bamboo['bodyfont'] == "Google") {
		$bodyfont = zen::cleanFonts($bamboo['body-google-font']);
		$bodyfont= '~"' .$bodyfont.'"';
	} else {
	...
	if($bamboo['headingfont'] == "Google") {
		$headingfont = zen::cleanFonts($bamboo['heading-google-font']);
	...
	if($bamboo['navfont'] == "Google") {
		$navfont = zen::cleanFonts($bamboo['nav-google-font']);
		$navfont= '~"' .$navfont.'"';
	} else {
	...
	$variables = 	"@basewidth:" .	$bamboo['twidth'] . ";\n";
	$variables .=	'@bodyfont:' .	$bodyfont . ";\n";
	$variables .=	'@logofontweight:~"' .	$bamboo["logo-weight"] . '";';
	$variables .=	"@basesize:" .	$bamboo['base-font-size'] . ";\n";
	$variables .=	"@body-font-weight:" .	$bamboo['body-font-weight'] . ";\n";
	$variables .=	"@logofontsize:" .	$bamboo['logo-font-size'] . ";\n";
	$variables .=	"@logofontfamily:" .	$logofont . ";\n";
	$variables .=	"@headingfontfamily:" .	$headingfont . ";\n";
	$variables .=	"@headingfontweight:" .	$bamboo["heading-font-weight"] . ";\n";
	$variables .= 	"@logofontcolor:" . $bamboo['logo-font-color'].";\n";
	$variables .= 	"@logofontcolorhover:" . $bamboo['logo-font-color-hover'].";\n";
	$variables .= 	"@menu-collapse:" . $bamboo['menu-collapse'].";\n";
	$variables .= 	"@grid-collapse:" . $bamboo['grid-collapse'].";\n";
	$variables .= 	"@primary:" . $bamboo['primary'].";\n";
	$variables .= 	"@secondary:" . $bamboo['secondary'].";\n";
	$variables .= 	"@btncolor:" . $bamboo['btncolor'].";\n";
	$variables .= 	"@btnhover:" . $bamboo['btnhover'].";\n";
	$variables .= 	"@btnbackground:" . $bamboo['btnbackground'].";\n";
	$variables .= 	"@btnbackgroundhover:" . $bamboo['btnbackgroundhover'].";\n";
	$variables .= 	"@bodyBackground:" . $bamboo['bodybackground'].";\n";
	$variables .= 	"@textColor:" . $bamboo['text-color'].";\n";
	$variables .= 	"@borderColor:" . $bamboo['border-color'].";\n";
	$variables .= 	"@headingsColor:" . $bamboo['heading-color'].";\n";
	$variables .= 	"@linkColor:" . $bamboo['link-color'].";\n";
	$variables .= 	"@linkColorHover:" . $bamboo['link-color-hover'].";\n";
	$variables .= 	"@dropdown-bg:" . $bamboo['dropdown-bg'].";\n";
	$variables .= 	"@dropdown-link-border-bottom:" . $bamboo['dropdown-link-border-bottom'].";\n";
	$variables .= 	"@dropdown-link-border-top:" . $bamboo['dropdown-link-border-top'].";\n";
	$variables .= 	"@dropdown-link-color:" . $bamboo['dropdown-link-color'].";\n";
	$variables .= 	"@dropdown-link-color-hover:" . $bamboo['dropdown-link-color-hover'].";\n";
	$variables .= 	"@taglineColor:" . $bamboo['tagline-color'].";\n";
	$variables .= 	"@taglineLeft:" . $tagline_left.";\n";
	$variables .= 	"@taglineTop:" . $tagline_top.";\n";
