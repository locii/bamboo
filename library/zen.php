...
class zen {
	...
	/**
		 ...
		 *
		 * This method must be invoked as: $zen = Zen::getInstance();
		 *
		 * @return  ZenGrid
		 *
		 * @since   2.0.0
...
/**
	 ...
	 *
	 */
	public function stickynav($enabled, $threshold)
	{
		if ($enabled) {
			ob_start();
			?>
			<script type="text/javascript">
				...
				jQuery(window).scroll(function(e){
					...
					jQuerybounds = <?php echo $threshold; ?> // boundary of when to change element to fixed and scroll
